...
class EPD_7in3f:
    ...
    def display_file(self, filepath, battery_level=None, orientation=None):
        ...
        from the file to the panel over SPI. All overlays (battery indicator,
        captions, branding) are applied to the buffer BEFORE calling this.
        """
        self.init()
        ...
        if orientation is None:
            ...
            for path in ['/sd/config.json', '/wifi_config.json']:
                try:
                    import json
